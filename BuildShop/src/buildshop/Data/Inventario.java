...
public abstract class Inventario {
	...
	/**
	 * valida el acceso del usuario para llamar al metodo excelProduct o ha
	 * mesangeError
	 */
	...
	/**
	 * valida el acceso del usuario para llamar al metodo excelPUsers o ha
	 * mesangeError
	 */
	...
	/**
	 * valida el acceso del usuario para llamar al metodo excelSells o ha
	 * mesangeError
	 */
	...
	public static void excelSells() throws Exception {
		...
		String titulo = "Ventas";
		 String title[]={"fecha","hora","Nº productos vendidos","Id producto","Nombre del preoducto","Cantidad","Precio unitario","precio total P",
                    "precio total venta","stock al momento", "Id del vendedor","nombre del vendedor"};
		 String sells[]=DataReader.readData("C:/BuildShop/DB/ventas.buildshop");
		 String sellsList[][]=AdminBSP.sellRegister(sells);
		 created(direccion,titulo,title,sellsList);
	}
	 ...
	 * 
	 * @param rutaArchivo
	 *            direccion absoluta del archivo a crear
	 * @param tipo
	 *            indica el tipo de tabla a crear
	 * @param title
	 *            indica el titulo de la hoja
	 * @param List
